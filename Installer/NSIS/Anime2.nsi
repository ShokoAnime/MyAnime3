...
Section /o "Default" DefaultSkin
	SetOutPath $SkinLocation\Default
	File Skins\Default\*.*
	
	SetOutPath $SkinLocation\Default\media
	File /nonfatal "Skins\[ Media ]\*.*"
	File /nonfatal Skins\Default\media\*.*

	SetOutPath $SkinLocation\Default\media\MyAnime
	File /nonfatal "Skins\[ Media ]\MyAnime\*.*"
	File /nonfatal Skins\Default\media\MyAnime\*.*
	
	RMDir /r "$APPDATA\Team MediaPortal\MediaPortal\Cache\Default"
SectionEnd

Section /o "DefaultWide" DefaultWide
	SetOutPath $SkinLocation\DefaultWide
	File Skins\DefaultWide\*.*
	
	SetOutPath $SkinLocation\DefaultWide\media
	File /nonfatal "Skins\[ Media ]\*.*"
	File /nonfatal Skins\DefaultWide\media\*.*

	SetOutPath $SkinLocation\DefaultWide\media\MyAnime
	File /nonfatal "Skins\[ Media ]\MyAnime\*.*"
	File /nonfatal Skins\DefaultWide\media\MyAnime\*.*
	
	RMDir /r "$APPDATA\Team MediaPortal\MediaPortal\Cache\DefaultWide"
SectionEnd
...
Section "un.$(NAME_Uninstall)" Uninstall
	...
	Delete "$SkinLocation\DefaultWide\Anime2*"
	Delete "$SkinLocation\DefaultWide\media\anime2*"
	Delete "$SkinLocation\DefaultWide\media\MyAnime\*"
	
	Delete "$SkinLocation\Default\Anime2*"
	Delete "$SkinLocation\Default\media\anime2*"
	Delete "$SkinLocation\Default\media\MyAnime\*"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
  ...
  !insertmacro MUI_DESCRIPTION_TEXT ${DefaultSkin} $(DESC_Default)
  !insertmacro MUI_DESCRIPTION_TEXT ${DefaultWide} $(DESC_DefaultWide)
...
Function DirectorySet
	...
	IntOp $0 0 + 0
	IfFileExists $SkinLocation\DefaultWide\basichome.xml 0 +3
	IntOp $0 $0 | ${SF_SELECTED}
	SectionSetFlags ${DefaultWide} $0
	
	IntOp $0 0 + 0
	IfFileExists $SkinLocation\Default\basichome.xml 0 +3
	IntOp $0 $0 | ${SF_SELECTED}
	SectionSetFlags ${DefaultSkin} $0
