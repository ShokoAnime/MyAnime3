...
echo -----------------------------------------------------------------------------
echo.
set NSISPATH=C:\program files (x86)\nsis\unicode\makensis.exe
if exist "%NSISPATH%" goto continue
set NSISPATH=
if exist nsislocation.txt goto readsettings
for %%D in ("C:\program files (x86)" "D:\program files (x86)" "E:\program files (x86)" "F:\program files (x86)") DO DIR %%D\makensis.exe /B /P /S >> nsislocation.txt
