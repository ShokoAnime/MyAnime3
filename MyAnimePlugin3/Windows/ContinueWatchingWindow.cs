...
namespace MyAnimePlugin3.Windows
{
  public class ContinueWatchingWindow : GUIWindow
  {
    ...
    [SkinControlAttribute(1451)]
    protected GUILabelControl dummyAnyRecords = null;
        ...
        if (ep != null)
        {
          ...
          switch (dlg.SelectedLabelText)
          {
            ...
            case "Go To Episode List":
              ...
              {
                foreach (AnimeEpisodeTypeVM anEpType in MainWindow.ContinueWatching_CurrentSeries.EpisodeTypesToDisplay)
                {
