...
namespace Shoko.MyAnime3
{
    public class ImageAllocator
    {
		...
		public static string GetWideBannerAsFileName(VM_AnimeGroup_User grp)
		{
		...
		public static string GetWideBannerAsFileName(VM_AniDB_Anime anime)
		{
			// check for user options
			List<string> banners = new List<string>();
			foreach (VM_TvDB_ImageWideBanner wdban in anime.AniDB_AnimeCrossRefs.TvDBImageWideBanners)
			{
		...
		public static string GetPosterAsFileName(VM_AniDB_Anime anime)
		{
			// check for user options
			string fileName = "";
		...
		public static String GetSeriesImage(VM_AnimeSeries_User ser, GUIFacadeControl.Layout viewMode)
		{
			string imgFileName = "";
			Size sz = PosterSize;
			...
			{
				case GUIFacadeControl.Layout.LargeIcons:
					imgFileName = GetWideBannerAsFileName(ser.Anime); sz = BannerSize; break;
				case GUIFacadeControl.Layout.List:
				case GUIFacadeControl.Layout.AlbumView:
				case GUIFacadeControl.Layout.Filmstrip:
				case GUIFacadeControl.Layout.CoverFlow:
					imgFileName = GetPosterAsFileName(ser.Anime); sz = PosterSize; break;
			}
		...
		public static String GetSeriesImageAsFileName(VM_AnimeSeries_User ser, GUIFacadeControl.Layout viewMode)
		{
			string imgFileName = "";
			...
			{
				case GUIFacadeControl.Layout.LargeIcons:
					imgFileName = GetWideBannerAsFileName(ser.Anime); break;
				case GUIFacadeControl.Layout.List:
				case GUIFacadeControl.Layout.AlbumView:
				case GUIFacadeControl.Layout.Filmstrip:
				case GUIFacadeControl.Layout.CoverFlow:
					imgFileName = GetPosterAsFileName(ser.Anime); break;
			}
		...
		public static String GetAnimeImageAsFileName(VM_AniDB_Anime anime, GUIFacadeControl.Layout viewMode)
		{
			string imgFileName = "";
