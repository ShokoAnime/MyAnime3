...
namespace Shoko.MyAnime3
{
    public class VideoHandler : GUIWindow
    {
        ...
        #region Vars
        public VM_AnimeEpisode_User curEpisode = null;
		public VM_AnimeEpisode_User prevEpisode = null;
...
/*        private string curFileName = "";
        ...
        {
            return Shoko.MyAnime3.SkinExtensions.BaseProperties + "." + which.Replace("_", ".").Replace("ñ", "_");
        }
        ...
        void SetGUIProperties(bool clear)
        {
            try
            {
                ...
                SetGUIProperty(GuiProperty.Play_Current_PlotOutline, "", true);
        ...
        void MarkEpisodeAsWatched(VM_AnimeEpisode_User episode)
        {
